...
export default function Blog() {
  return (
    <section id="blog" className="py-24 bg-saffron-50 relative border-t border-saffron-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <a href="#" className="flex-shrink-0 px-6 py-3 rounded-full border-2 border-saffron-600 text-saffron-600 font-semibold hover:bg-saffron-600 hover:text-white transition-colors">
            View All News
          </a>
        </div>
